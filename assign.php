 ...
 <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-5 bg-light mt-4 p-2 rounded">
        <div class="">
          <div >
              <h5 class="card-title text-center" style="color: blue">VEHICLE ASSIGNMENT</h5>
             <?php 
       ...
       <form action="assignadd.php" method="POST">       
  
                                <div class="form-group row">
                             
                                    <label style="font-weight: bold;" class="col-sm-4 col-form-label">Driver</label>
                                    <div class="col-sm-10">
...
while($row=mysqli_fetch_array($query_run)) {?>
 ...
 ?>
                ...
                <div class="form-group row">
                                    ...
                                    <label style="font-weight: bold;" class="col-sm-4 col-form-label">Cabinet Secretary</label>
                                    <div class="col-sm-10">
                                    <select class="form-control" name="st">
                                      <option value="">Select Cabinet Secretary</option>
                                           <?php 
                                 //  session_start();
$con=mysqli_connect("127.0.0.1","root","","nakuru");
...
while($row=mysqli_fetch_array($query_run)) {?>
 ...
 ?>
       ...
       <div class="form-group row">
                                    ...
                                    <label style="font-weight: bold;" class="col-sm-4 col-form-label">Vehicle</label>
                                    <div class="col-sm-10">
                                    <select class="form-control" name="vh">
...
while($row=mysqli_fetch_array($query_run)) {?>
                                      ...
                                      <option><?php echo $row['platenumber'];?></option>
                                         <?php 
}
 ?>
                                    </select>
  ...
  <div class="">
    <button type="submit" id="Register" name="" class="btn btn-success">Assign</button>
