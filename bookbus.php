 ...
 <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-5 bg-light mt-4 p-2 rounded">
        <div class="">
          <div >
              <h5 class="card-title text-center" style="color: blue">BOOK A BUS</h5>
             <?php 
       ...
       <form action="bookbusadd.php" method="POST">       
  ...
  <div class="form-group">
                                    ...
                                    <label  class="col col-form-label">Bus Number Plate</label>
                                    <div class="col-sm-10">
