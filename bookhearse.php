...
<ul class="navbar-nav  mt-lg-0 mx-auto">
 ...
 <ul class="navbar-nav  mt-lg-0 ml-auto">
 	<li class="nav-item">
        <a href="user.php" style="text-decoration: none; color: white; font-family:Verdana; cursor: pointer; font-weight: bolder;">HOME<i class="fa fa-home"></i></a>
      </li>
 ...
 <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-5 bg-light mt-4 p-2 rounded">
        <div class="">
          <div >
              <h5 class="card-title text-center" style="color: blue">BOOK A HEARSE</h5>
             <?php 
       ...
       <form action="bukhearseadd.php" method="POST">       
  <div class="form-group">
  <label for="idn" class="col col-form-label">Representative ID</label>
  <div class="col-sm-10">
      <input type="text" class="form-control" id="idn" placeholder="ID Number" name="id" maxlength="10" required="">
  </div>
  </div>
              <div class="form-group">
  <label for="inputEmail3" class="col col-form-label">Representative Name</label>
  <div class="col-sm-10">
  ...
  <div class="form-group">
                                    ...
                                    <label  class="col col-form-label">Hearse Number Plate</label>
                                    <div class="col-sm-10">
...
while($row=mysqli_fetch_array($query_run)) {?>
 ...
 ?>
                                     ...
                                     <div class="form-group">
  <label for="nm" class="col col-form-label">Preferred Date</label>
  <div class="col-sm-10">
      <input type="date" class="form-control" id="nm" placeholder="contacts"  name="date" required="">
  </div>
  </div>
              <div class="form-group">
  <label for="nm" class="col col-form-label">Representative Phone Number</label>
  <div class="col-sm-10">
  ...
  <div class="form-group">
  <div class="">
    <button type="submit" id="Register" name="" class="btn btn-warning">Book Bus</button>
