...
$pdf->Cell(59	,5,'ALL DRIVERS',0,1);//end of line
...
$pdf->Cell(50	,5,'DRIVER ID',1,0);
$pdf->Cell(50	,5,'DRIVER NAME',1,0);
$pdf->Cell(50	,5,'DRIVER CONTACTS',1,1);//end of line
...
while($item=mysqli_fetch_array($query)){
	$pdf->Cell(50,5,$item['did'],1,0);
	$pdf->Cell(50,5,$item['name'],1,0);
	$pdf->Cell(50,5,$item['contacts'],1,1,'L');//end of line
