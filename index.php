    ...
    <div class="row">
      <div class="col-sm-9 col-md-5 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
              <h5 class="card-title text-center" style="color: blue">NAKURU COUNTY GOVERNMENT</h5>
              <?php 
                 if (@$_GET['Empty']==true)
                 {
                   ?>
...
<?php 
             ...
             <div style="float:right;"><a href="registration.php" style="text-decoration: none">Register Here</a> </div> 
            </form>
          </div>
        </div>
      </div>
