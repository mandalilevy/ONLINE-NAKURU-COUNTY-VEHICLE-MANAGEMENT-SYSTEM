 ...
 <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-5 bg-light mt-4 p-2 rounded">
        <div class="">
          <div >
              <h5 class="card-title text-center" style="color: blue">REPORT VEHICLE ISSUE</h5>
             <?php 
       ...
       <form action="issueadd.php" method="POST">       
...
while($row=mysqli_fetch_array($query_run)) {?>
 ...
 ?>
       ...
       <div class="form-group row">
                                    ...
                                    <label style="font-weight: bold;" class="col-sm-4 col-form-label">Vehicle Issue</label>
                                    <div class="col-sm-10">
  ...
  <div class="">
    <button type="submit" id="Register" name="" class="btn btn-success">Report Issue</button>
